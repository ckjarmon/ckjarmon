...
<div class="row noMargin" style=" display: flex;
  width: 400; width: 50%; margin: 0px;">
  <div class="one">
   <img  align = "center" src="me.png" width = 500>
  </div>
  <div class="two" style=" " display: flex;
  width: 400; width: 50%; margin: 0px;"padding-top: 80px;">
